...
<?php if ($is_admin == "super") { ?><!-- <div style='float:left; width:<?=$table_width?>px; text-align:center;'>RUN TIME : <?=get_microtime()-$begin_time;?><br></div> --> <? } ?>
</body>
</html>
<?php
...
mysqli_close($query_link);
//unset($g4,$member,$default,$config);
?>