            ...
            <td width="540" bgcolor="#FFFFFF">
                ...
                for ($i=0; $row=sql_fetch_array($result); $i++) {
                    ...
                    <tr height=25 bgcolor="#F6F6F6" align="center">
                        ...
                        <td align="left">&nbsp;$row[po_content]</a></td>
...
<tr>
    <td height="40" align="center" valign="bottom"><a href="javascript:window.close();"><img src="<?=$g4[bbs_img_path]?>/close.gif" border="0"></a></td>
</tr>
</table>
<br>
