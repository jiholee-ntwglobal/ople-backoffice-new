...
if ($is_admin) 
    echo "<p align=center style='margin-top:20px;'><a href='./$g4[shop_admin_path]/contentform.php?w=u&co_id=$co_id'><img src='$g4[shop_img_path]/btn_admin_modify.gif' border=0></a></p>";
