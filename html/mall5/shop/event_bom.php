...
<div>
<img src='http://115.68.20.84/main/bom_event.jpg' border="none">
<? 
display_event('10', 1395382518, 4, 4, 160, 160, ''); 

echo "<br><br><br><br><br><h2>센스있는 엄마라면 이런 것도 준비해 주세요.</h2>"; 
display_event('10', 1395386201 , 4, 4, 160, 160, ''); 
?>
