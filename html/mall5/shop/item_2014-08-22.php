    ...
    <td align=center valign=top>
        <table cellpadding=0 cellspacing=0>
            ...
            <tr><td colspan=3 align=center>
				...
				<?}else{?>
                <table cellpadding=1 cellspacing=0 bgcolor=#E4E4E4><tr><td><?=get_large_image($it[it_id]."_l1", $it[it_id], false)?><?=get_it_image($middle_image, 200, 200,null,"onclick=\"return false;\"",false,false);?></a></td></tr></table></td></tr>
				<?}?>
...
//                        echo "</a> &nbsp;";
    ...
    <td width=480 valign=top align=center>
		...
		<!--<tr>
            <td height='25' colspan='3' align='center' style='font-weight:bold;'>원데이 세일 상품</td>
        <tr><td colspan=3 height=1 bgcolor=#eaeaea></td></tr>
		<tr>
            <td height=25>&nbsp;&nbsp;&nbsp; · 재고수량</td>
            <td align=center>:</td>
            <td><span class='it_stock' style='font-weight:bold; color:#ff0000;'></span>개 남음 </td></tr>
        <tr><td colspan=3 height=1 bgcolor=#eaeaea></td></tr>
		<tr>
            <td height=25>&nbsp;&nbsp;&nbsp; · 남은시간</td>
            <td align=center>:</td>
            <td><span  style='font-weight:bold; color	:#ff0000;'></span> 남음</td></tr>
        <tr><td colspan=3 height=1 bgcolor=#eaeaea></td></tr>-->
		<?}?>
        ...
        <tr>
            ...
            <a href="#" onclick="fitemcheck(document.fitem, 'direct_buy'); return false;";><!--<img src='<?=$g4[shop_img_path]?>/btn2_now_buy.gif' border=0>--><img src="<?=$g4['path']?>/images/category/category_buy_box01_btn_buy.gif" width="95" height="40" hspace="1" border="0"></a>
