...
?>
    <td width="<? echo $td_width ?>%" align=left valign=top>
        ...
        <tr>
            <td rowspan=2 width='' align=center>&nbsp;<?=$href?><?=get_it_image($row[it_id]."_s", $img_width, $img_height,$row['it_id'],null,false,true,true)?></a>&nbsp;</td>
            <td width=50%><?=$href?><?=it_name_icon($row,$row['it_name'],1,'list')?></a></td>
