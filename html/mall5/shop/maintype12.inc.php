...
?>
    <td width="<?=$td_width?>%" align=center valign=top>
        ...
        <tr><td align=center><?=$href?><?=get_it_image($row[it_id]."_s", $img_width, $img_height,$row['it_id'],null,false,true,true)?></a></td></tr>
        <tr><td align=center><?=$href?><?=it_name_icon($row,$row['it_name'],1,'list')?></a></td></tr>
