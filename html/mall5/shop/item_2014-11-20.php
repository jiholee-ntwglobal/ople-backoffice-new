...
//                        echo "</a> &nbsp;";
    ...
    <td valign=top align=center style='padding:20px 40px;'>
        ...
        <?php if (!$it[it_gallery]) { // 갤러리 형식이라면 가격, 구매하기 출력하지 않음 ?>
            ...
            <?php } else { ?>
				...
				*/
				...
				<?php }?>
				<?php if($it_id == '1332425915' || $it_id == '1334852796'){?>
				<tr>
					<td colspan=2><span style="color:#ff0000; font-weight:bold;font-size:14px;"><예약주문 상품></span><br/><strong>해당상품 주문 폭주로 인하여 일시 품절 상태이며 12월 초순 일괄 발송 예정입니다.</strong></td>
				</tr>
				<?php }?>
            <?php } ?>
        ...
        <tr>
            ...
            <a href="javascript:fitemcheck(document.fitem, 'cart_update');"><!--<img src='<?=$g4[shop_img_path]?>/btn2_cart.gif' border=0>--><img src="<?php echo $g4['path'];?>/images/category/category_buy_box01_btn_cart.gif" border="0"></a>
            <?php } ?>
