...
<tr>
	<th>카드 번호</th>
	<td><input class=ed type='text' name="x_card_num" size="30" numeric required itemname='카드번호' maxlength=16 onblur='master_card_price_view(this.value);samsung_chk();'> (숫자만 입력하십시오.)</td>
</tr>
