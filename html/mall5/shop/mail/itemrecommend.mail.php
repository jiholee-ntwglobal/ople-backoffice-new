                ...
                <tr>
                    <td>
                        <table width=100% cellpadding=10 cellspacing=0> 
                            ...
                            <tr><td bgcolor=#FFFFFF style='padding-left:15px; padding-bottom:15px'><font color=#5AB0D4><B><?=$from_name?> </B></font>님께서 추천하신 상품입니다.
                                    <table width=98% cellpadding=1 cellspacing=0 bgcolor=#DFDFDF>
                                        <tr><td>
                                                <table width=100% cellpadding=20 cellspacing=0 bgcolor=#F8F8F8>
                                                    <tr><td><b><a href='<?="$g4[shop_url]/item.php?it_id=$it_id"?>' target=_top><?=$it_name?></a></b></td></tr>
                                                    <tr>
                                                        <td valign=top style='padding:10px;line-height:150%'><a href='<?="$g4[shop_url]/item.php?it_id=$it_id"?>' target=_top><img src='<?="$g4[url]/data/item/$it_mimg"?>' border=0 align=left hspace="10"></a><?=$content?></td>
                                                    </tr>
                                                    <tr><td>※ 이 메일은 광고 메일이 아닙니다.</td></tr>
                                                </table>
                                            </td></tr>
                                    </table>
                                </td></tr>
