...
include_once "$g4[shop_path]/listcategory3.inc.php";
?>

<table width=755 align="left" cellpadding=0 cellspacing=0>
    <tr>
        <td>
...
$sql_list2 = " order by cnt desc, $order_by it_order, it_id desc ";
...
$sql_common = " from $g4[yc4_item_table] where match(ca_id, ca_id2, ca_id3, ca_id4, ca_id5) against('$ca_id*' in boolean mode) and it_use = '1' and it_discontinued=0 ".$hide_caQ.$hide_makerQ;
