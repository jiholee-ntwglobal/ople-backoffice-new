...
for ($i=0; $i<10000; $i++)
{
    ...
    while ($row=sql_fetch_array($result))
    {
        ...
        $roll_text[$i] .= "<tr><td align=center>$href".get_it_image($row[it_id]."_s", $img_width, $img_height,$row['it_id'],null,false,true,true)."</a></td></tr>";
        $roll_text[$i] .= "<tr><td align=center>$href".addslashes(it_name_icon($row,$row['it_name'],1,'list'))."</a></td></tr>";
