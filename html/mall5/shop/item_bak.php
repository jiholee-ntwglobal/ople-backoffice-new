...
<tr>
    ...
    <td width=460 valign=top align=center>
        <table width=430 cellpadding=0 cellspacing=2 bgcolor=#fa5a00><tr>
		<td bgcolor=white style="padding:4px;" colspan=2 valign=top><span style='font-size:14px; font-family:돋움;'><strong><?=it_name_icon($it, stripslashes($it[it_name]), 0)?></strong></span></td>
		</tr></table>
	...
	<?if($it_id == '1300274302'){ // 김선용 201103 : 요오드 임시 예약 신청?>
	<tr>
		<td colspan=3><div style="line-height:150%; font-weight:bold; border:4px solid #eee;">본 제품은 더이상 주문을 받지 않습니다. 주문 관리가 어려워 예약으로만 접수를 합니다. 예약 정보를 입력해주시면 제품이 입고될때 고객님께 먼저 등록해주신 고객순으로 이메일 과 문자로 안내를 해드리겠습니다.<br/><a href="<?=$g4['path']?>/sjsjin/reser_iodine_write.php" title="예약신청하기"><span style="font-size:12pt; font-weight:bold;">예약신청</span></a> <<<= 클릭해주세요</div></td>
	</tr>
	<tr><td colspan=3 height=20></td></tr>
	<?}?>
