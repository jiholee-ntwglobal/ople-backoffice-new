...
if($_POST['mode']){
	...
	$insert_cnt = category_item_insert($_POST['new_cate'] ,$it_id_arr);

	alert("카테고리 상품 등록이 완료되었습니다.(".$insert_cnt."건)","./category_item_no.php?old_cate=$_POST[old_cate]");
}
...
<a href="category_item_no.php">미적용 상품</a>(<?php echo $total_info['cnt']; ?>)<br/><br/>
<form name="frm">
<input type="hidden" name="mode" value="convert"/>
<table width='100%'>
	<tr>
		<td width="55%" align="left">
		<select name="old_cate" onchange="location.href='category_item_no.php?old_cate='+this.value">
