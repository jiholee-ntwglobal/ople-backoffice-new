...
<?=cheditor1('fm_head_html', '100%','200');?>
<?=cheditor1('fm_tail_html', '100%','200');?>
...
<tr>
    <td>상단 내용</td>
    <td style='padding-top:5px; padding-bottom:5px;'><?=cheditor2('frmfaqmasterform', 'fm_head_html', $fm[fm_head_html]);?></td>
</tr>
<tr>
    <td>하단 내용</td>
    <td style='padding-top:5px; padding-bottom:5px;'><?=cheditor2('frmfaqmasterform', 'fm_tail_html', $fm[fm_tail_html]);?></td>
</tr>
