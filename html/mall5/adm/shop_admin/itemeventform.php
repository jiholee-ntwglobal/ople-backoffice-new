...
<?=cheditor1('ev_head_html', '100%','200');?>
<?=cheditor1('ev_tail_html', '100%','200');?>
...
<? if ($timg_str) { echo "<tr><td colspan=4>$timg_str</td></tr>"; } ?>
    ...
    <td>상단 내용</td>
    <td colspan=3 align=right style='padding-top:5px; padding-bottom:5px;'><?=cheditor2('feventform', 'ev_head_html', stripslashes($ev[ev_head_html]));?></td>
</tr>
<tr>
    <td>하단 내용</td>
    <td colspan=3 align=right style='padding-top:5px; padding-bottom:5px;'><?=cheditor2('feventform', 'ev_tail_html', stripslashes($ev[ev_tail_html]));?></td>
</tr>
