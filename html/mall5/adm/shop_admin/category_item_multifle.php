...
if($_POST['mode']){
	...
	alert("카테고리 상품 등록이 완료되었습니다.(".$insert_cnt."건)","./category_item_multifle.php?old_cate=$_POST[old_cate]");
}
...
<a href="category_item_multifle.php">전체 상품</a>(<?php echo $total_info['cnt']; ?>)<br/><br/>
<form name="frm">
<input type="hidden" name="mode" value="convert"/>
<table width='100%'>
	<tr>
		<td width="55%" align="left">
		<select name="old_cate" onchange="location.href='category_item_multifle.php?old_cate='+this.value">
...
function seach_it_name(){
	...
	location.href = "category_item_multifle.php?" + $("form[name=frm]").serialize();
}
