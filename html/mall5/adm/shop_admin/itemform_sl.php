...
<tr class=ht>
    <td>상품명</td>
    <td colspan=3>
        <input type=text name=it_name value='<?=get_text(stripslashes($it[it_name]))?>' style='width:97%;' required itemname='상품명' class=ed>
    </td>
</tr>
...
<tr class=ht>
    ...
    <td>병수량</td>
    <td>
        <input type=text name="it_bottle_count" value='<?=$it['it_bottle_count']?>' size=4 class=ed> 병
    </td>
</tr>
