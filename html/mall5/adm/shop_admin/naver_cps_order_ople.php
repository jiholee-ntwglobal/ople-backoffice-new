    ...
    <div class="row">
        ...
        <div class="col-lg-2">
            <?php if (count($list_value)>0) { ?>
                <button class="btn btn-success" type="button" onclick="location.href='./naver_cps_order_ople.php?excel=download<?php echo $dstr?>'">엑셀다운로드</button>
            <?php } ?>
        </div>
    </div>
</form>
