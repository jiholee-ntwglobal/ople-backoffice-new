if (typeof(SIDEVIEW_JS) == 'undefined') // 한번만 실행
{
    ...
    function SideView(targetObj, curObj, mb_id, name, email, homepage)
    {
		...
		// 김선용 201309 : 주문서에서는 비회원인 경우 mb_id=비회원 으로 넘어옴
		mb_id = (regx_number_alpha(mb_id) == true ? mb_id : '');
        ...
        //if (g4_is_admin == "super") {
            ...
            if (mb_id){
				...
				// 김선용 201309 : 주문서조회
				this.insertTail("orderlist", "<a href='"+g4_path+"/" + g4_admin + "/shop_admin/orderlist2.php?&sel_field=mb_id&search="+mb_id+"' target='_blank'>주문내역조회</a>");
			}
            // 포인트내역
            if (mb_id)
