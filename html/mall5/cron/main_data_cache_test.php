...
while($data = mysql_fetch_assoc($sql)){
    ...
    $result_arr['hotdel'][$data['sort']]['it_id'] = $data['it_id'];
    $result_arr['hotdel'][$data['sort']]['it_event_amount'] = $data['it_event_amount'];
    $result_arr['hotdel'][$data['sort']]['it_amount_msrp'] = $data['it_amount_msrp'];
    $result_arr['hotdel'][$data['sort']]['it_amount_msrp_krw'] = $msrp_krw;
    $result_arr['hotdel'][$data['sort']]['dc_per'] = $dc_per;
    $result_arr['hotdel'][$data['sort']]['img_link'] = $data['img_link'];
    $result_arr['hotdel'][$data['sort']]['end_fg'] = false;
...
if($hotdeal_cnt < 9){
    ...
    while($data = mysql_fetch_assoc($sql)){
        ...
        $result_arr['hotdel'][$hotdeal_cnt]['it_id'] = $data[it_id];
        $result_arr['hotdel'][$hotdeal_cnt]['it_event_amount'] = $data[it_event_amount];
        $result_arr['hotdel'][$hotdeal_cnt]['it_amount_msrp'] = $data[it_amount_msrp];
        $result_arr['hotdel'][$hotdeal_cnt]['it_amount_msrp_krw'] = $msrp_krw;
        $result_arr['hotdel'][$hotdeal_cnt]['dc_per'] = $dc_per;
        $result_arr['hotdel'][$hotdeal_cnt]['img_link'] = $data[img_link];
        $result_arr['hotdel'][$hotdeal_cnt]['end_fg'] = true;
