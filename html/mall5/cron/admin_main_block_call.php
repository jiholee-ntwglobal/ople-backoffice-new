...
/*
----------------------------------------------------------------------
file name	 : admin_main_block_call.php
comment		 : 관리자 메인용 html block 생성(전화요청)
date		 : 2015-05-15
...
$sql = "SELECT sum(1) AS total_cnt,
		   sum(if(isnull(confirm_dt), 1, 0)) AS no_confirm_cnt,
		   sum(
			  if(date_format(create_dt, '%Y%m%d') = date_format(NOW(), '%Y%m%d'),
				 1,
				 0))
			  AS today_cnt,
		   sum(
			  if(
				 ...
				 AND isnull(confirm_dt),
				 1,
				 0))
			  AS today_no_confirm_cnt
	  FROM yc4_outbound_call";
...
<table width=100% cellpadding=0 cellspacing=0>
	<tr>
		...
		<table border='0' cellpadding='0' cellspacing='1'>
			<tr>
				<td height='24'><img src='../adm/img/icon_title.gif' width=20 height=9> <font color='#525252'><b>전화요청</b></font> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			</tr>
		</table>
		<table width=100% cellpadding=0 cellspacing=0>
			<tr>
		...
		<td width=20% align=right><a href='./shop_admin/call.php'><img src='../adm/img/icon_more.gif' width='43' height='11' border=0 align=absmiddle></a></td>
	</tr>
</table>
<table width=100% cellpadding=0 cellspacing=0>
	...
	<tr class='list1 col1 ht center' height="30">
		...
		<td><?php echo number_format($cnt_info['no_confirm_cnt']); ?></td>
		<td><?php echo number_format($cnt_info['today_cnt']); ?></td>
		<td><?php echo number_format($cnt_info['today_no_confirm_cnt']); ?></td>
	</tr>
