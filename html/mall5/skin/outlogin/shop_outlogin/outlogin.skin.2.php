...
<table width=188 cellpadding=1 cellspacing=0 bgcolor=#cccccc>
<tr>
    <td>
        ...
        <tr><td align=center><a href="<?=$g4['shop_path']?>/wishlist.php"><img src='<?=$outlogin_skin_path?>/img/btn_wishlist.gif' border=0></a>
            </td></tr>
