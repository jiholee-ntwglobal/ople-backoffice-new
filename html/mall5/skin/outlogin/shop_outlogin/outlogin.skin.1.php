...
<table bgcolor=#CCCCCC width=188 cellpadding=1 cellspacing=0>
<form name="fhead" method="post" onsubmit="return fhead_submit(this);" action="<?=$faction?>" autocomplete="off">
