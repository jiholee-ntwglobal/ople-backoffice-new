...
<table width="100%" align="center" cellpadding="0" cellspacing="0" style='margin-top:20px;'><tr><td>
            ...
            <table width="100%" cellspacing="0" cellpadding="0">
                ...
                ?>
				<!-- @lowset_price_20191206 -->
				<tr>
                    <td height=30>
                        &nbsp;&nbsp;<font style="font:normal 11px 돋움; color:#BABABA;">주문시각 :</font>
                        <font  style='normal 11px 돋움;'>
                            <?=$view['wr_10']?>
                        </font>
                    </td>
                </tr>
                ...
                <tr>
                    <td height=30>
                        &nbsp;&nbsp;<font style="font:normal 11px 돋움; color:#BABABA;">주문번호 :</font>
                        <font  style='normal 11px 돋움;'>
                            <?=$view['wr_2']?>
                        </font>
                    </td>
                ...
                <tr>
                    <td height=30>
                        &nbsp;&nbsp;<font style="font:normal 11px 돋움; color:#BABABA;">상품명 :</font>
                        <font  style='normal 11px 돋움;'>
                            <?=$view['wr_3']?>
                        </font>
                    </td>
				...
				<tr>
                    <td height=30>
                        &nbsp;&nbsp;<font style="font:normal 11px 돋움; color:#BABABA;">상품코드 :</font>
                        <font  style='normal 11px 돋움;'>
                            <?=$view['wr_9']?>
                        </font>
                    </td>
                ...
                <tr>
                    <td height=30>
                        &nbsp;&nbsp;<font style="font:normal 11px 돋움; color:#BABABA;">상품가($) :</font>
                        <font  style='normal 11px 돋움;'>
                            <?=$view['wr_6']?>$
                        </font>
                    </td>
                ...
                <tr>
                    <td height=30>
                        &nbsp;&nbsp;<font style="font:normal 11px 돋움; color:#BABABA;">상품가(원) :</font>
                        <font  style='normal 11px 돋움;'>
                            <?=number_format($view['wr_7'])?>원
                        </font>
                    </td>
                </tr>
                <tr><td height='1' bgcolor='#E7E7E7'></td></tr>
                <tr>
                    <td height=30>
                        &nbsp;&nbsp;<font style="font:normal 11px 돋움; color:#BABABA;">수량 :</font>
                        <font  style='normal 11px 돋움;'>
                            <?=$view['wr_8']?>
                        </font>
                    </td>
                ...
                <?if($view['wr_reply'] == 'A'){?>
                    <tr>
                        <td height=30>
                            &nbsp;&nbsp;<font style="font:normal 11px 돋움; color:#BABABA;">포인트 내용 :</font>
                            <font  style='normal 11px 돋움;'>
                                <?=$view['wr_5']?>
                            </font>
                        </td>
                    ...
                    <tr>
                        <td height=30>
                            &nbsp;&nbsp;<font style="font:normal 11px 돋움; color:#BABABA;">포인트 지급 :</font>
                            <font  style='normal 11px 돋움;'>
                                <?=$view['wr_4']?>
                            </font>
                        </td>
