...
<div class="mainSpotArea">
    ...
    <div class="Main_bannerArea">
        ...
        <?php if(date('Ymd') >= '20150216' && date('Ymd') <= '20150530'){ ?>
      <p class="event_banner"><img src="http://115.68.20.84/mall6/main/main_spot_eventR_mastercard.jpg" alt="메인이벤트" border="0" usemap="#event"></p>
	...
	<p style="position: absolute;right: -192px;"><a href="<?php echo $g4['shop_path'];?>/master_hanacard_event.php"><img src="http://115.68.20.84/mall6/main/man_Spot_bannerR_hanacard.png" alt="카드이벤트"></a></p>
        <?php }else{?>
            <p class="event_banner"><img src="http://115.68.20.84/mall6/main/main_spot_eventR_shinhan_bom.jpg" alt="메인이벤트" border="0"></p>
        <?php }?>
    </div>
    <!--EventSpotArea-->
