...
*/
$cate_depth_1 = sub_cate_cache_load_new('20');
$cate_depth_2 = sub_cate_cache_load_new('21');
$cate_depth_3 = sub_cate_cache_load_new('22');
$cate_depth_4 = sub_cate_cache_load_new('23');
$cate_depth_5 = sub_cate_cache_load_new('24');
