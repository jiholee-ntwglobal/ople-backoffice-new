...
*/
$cate_depth_1 = sub_cate_cache_load_new('40');
$cate_depth_2 = sub_cate_cache_load_new('41');
$cate_depth_3 = sub_cate_cache_load_new('42');
$cate_depth_4 = sub_cate_cache_load_new('43');
$cate_depth_5 = sub_cate_cache_load_new('44');
