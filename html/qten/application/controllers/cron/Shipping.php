...
//        }
    ...
    public function transfer_shipping_order()
    {
        ...
        $order_result = $this->order_model->getOrders(
            ...
            m.total_amount, m.shipping_amount,date_format(o.order_date,'%y%m%d') shipping_order_date");
        ...
        foreach ($order_result->result_array() as $order_data){
            ...
            $order_data['shipping_order_code'] = element('shipping_order_code_prefix', $channel).element('shipping_order_date', $order_data). str_pad(dechex(element('order_id', $order_data)), 6, '0', STR_PAD_LEFT);
...
//            }
    ...
    private function generateNs01Data($order_data,$channel_code)
    {
        ...
        if($channel_code == 'A' || $channel_code == 'B' || $channel_code == 'XA'){
            $data['market_type'] = 'A';
        }elseif($channel_code == 'G' || $channel_code == 'H' || $channel_code == 'XG'){
            $data['market_type'] = 'G';
        }
