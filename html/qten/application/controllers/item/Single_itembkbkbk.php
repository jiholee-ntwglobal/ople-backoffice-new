...
class Single_item extends CI_Controller
{
    ...
    private function list()
    {
        ...
        $select ='i.item_info_id, b.comment, i.channel_item_code, i.discount_price, i.discount_unit, i.channel_id, v.virtual_item_id, item_alias, i.create_date, vd.master_item_id, i.origin_price, i.upload_price';
    ...
    function updateProductPrice(){
        ...
        foreach ($update_data_result ->result_array() as $date_info){
            ...
            switch ($date_info['channel_id']){
                ...
                echo $result;
                    echo $channel_item_code;
                    echo element('basic_price',$price_info);
                    exit;
                    if($discount_unit != 'N'){
