...
class Vcode extends CI_Controller
{
    ...
    public function index()
    {
        ...
        // in절은 너무 많으면 오류가 나요 20200115 KSJ
        $where_in_arr = array_chunk($where_in,1000);
        foreach ($where_in_arr as $where_val) {
            $master_vitual_Detail_result = $this->master_vitual_item_model->getVirtualItemDetail(array('virtual_item_id_in' => $where_val));
