...
?>
<h4>단품 품절, 품절해제 히스토리</h4>

<ul class="nav nav-pills">
    <li class="<?php if($status == '1') echo 'active'; ?>"><a href="#" onclick="location.href='<?php echo site_url('item/soldout_history?status=1'); ?>'" data-toggle="tab">성공</a></li>
    <li class="<?php if($status == '2') echo 'active'; ?>"><a href="#" onclick="location.href='<?php echo site_url('item/soldout_history?status=2'); ?>'" data-toggle="tab">실패</a></li>
</ul>

<form action="<?php echo site_url('/item/soldout_history'); ?>" id="frm" class="form-inline text-right" method="get">
...
<form id="excel-hidden-form" method="GET" action="<?php echo site_url('/item/soldout_history'); ?>">
    <input type="hidden" name="status" value="<?php echo $status; ?>">
