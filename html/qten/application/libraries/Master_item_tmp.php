...
//        $this->CI->load->model('openmarket_model');
	...
	private function generateDescHtml(){
		...
		if(!$decription_info || !is_array($decription_info)){
...
//						'block_num' => ++$block_num,
//						'block_name' => '제품설명',
//						'description' => str_replace(element('replace_text',$this->sales_channel_config), element('replace_value',$this->sales_channel_config), element('desc_kor',$decription_info))
//					)
//					, true);
//		}
