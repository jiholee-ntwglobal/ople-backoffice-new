...
class Paging
{
    ...
    public function create()
    {
        ...
        if ($this->first_link !== FALSE)
        {
            ...
            {
                $output .= $this->disabled_first_tag_open . "<a href='#'>" . $this->first_link . "</a>" . $this->disabled_first_tag_close;
            }
            else if ($this->display_first_always === TRUE OR $this->cur_page != 1)
            {
                $output .= $this->first_tag_open.'<a href="'.$base_url.'1'.$this->add_param.')">'.$this->first_link.'</a>'.$this->first_tag_close;
            }
        }
        ...
        if ($this->prev_link !== FALSE)
        {
            ...
            {
                $output .= $this->disabled_prev_tag_open . "<a href='#'>" . $this->prev_link . "</a>" . $this->disabled_prev_tag_close;
            }
            else if ($this->display_prev_always === TRUE OR $this->cur_page != 1)
            {
                ...
                $output .= $this->prev_tag_open.'<a href="'.$base_url.$i.$this->add_param.')">'
        ...
        if ($this->display_pages !== FALSE)
        {
            for ($loop = $start -1; $loop <= $end; $loop++)
            {
                ...
                if ($i >= 1)
                {
                    ...
                    {
                        $output .= $this->item_tag_open.'<a href="'.$base_url.$loop.$this->add_param.')">'.$loop.'</a>'.$this->item_tag_close;
                    }
                }
            }
        }
        ...
        if ($this->next_link !== FALSE)
        {
            ...
            {
                $output .= $this->disabled_next_tag_open . "<a href='#'>" . $this->next_link . "</a>" . $this->disabled_next_tag_close;
            }
            else if ($this->display_next_always === TRUE OR $this->cur_page != $num_pages)
            {
                ...
                $output .= $this->next_tag_open.'<a href="'.$base_url.$i.$this->add_param.')">'.$this->next_link.'</a>'.$this->next_tag_close;
            }
        }
        ...
        if ($this->last_link !== FALSE)
        {
            ...
            {
                $output .= $this->disabled_last_tag_open . "<a href='#'>" . $this->last_link . "</a>" . $this->disabled_last_tag_close;
            }
            else if ($this->display_last_always === TRUE OR $this->cur_page != $num_pages)
            {
                $i = $num_pages;

                $output .= $this->last_tag_open.'<a href="'.$base_url.$i.')">'.$this->last_link.'</a>'.$this->last_tag_close;
            }
        }
