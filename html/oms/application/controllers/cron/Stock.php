...
class Stock extends CI_Controller
{
    ...
    public function check_channel_sales_item_stock()
    {
        ...
        /**
         * 해외 사업자용 상품들
         * 세일즈 팀 요청에 의해 재고 체크 기준이 2 -> 0으로 변경         *
         */
        $overseasInventoryCheckNum = 0; // 해외 사업자 $overseasInventoryCheckNum 보다 재고가 >= 품절해제, 작으면 품절
...
//                  'exclude_account_type_bit_soldout'=>array('4','1','2'), /*해외품절,해외판매중,재고*/
                    'exclude_account_type_bit_soldout'=>array('1','4', $overseasInventoryCheckNum), /*해외판매,해외품절,재고*/
                    'restrict_customer_clearance_in' => array(0,2)));
            ...
            $instock_item_result = $this->master_item_stock_model->getItemStockInfo(
                array(
                    ...
                    /*  'currentqty_upper' => 5,
                      'exclude_account_type_bit_lower' => 1,*/
                    'exclude_account_type_bit_insotck'=>array('1','4', $overseasInventoryCheckNum), /*해외판매,해외품절,재고*/
                    'restrict_customer_clearance_in' => array(0,2)));
            ...
            $soldout_option_item_result	= $this->master_item_stock_model->getOptionItemStockInfo(
                ...
                ,	'stock_status'						=> 'Y'
                    /*,	'currentqty_lower'					=> 2
                    ,	'exclude_account_type_bit_lower'	=> 1*/
                ,   'exclude_account_type_bit_soldout'=>array('1','4', $overseasInventoryCheckNum) /*해외품절,해외판매중,재고*/
                    /*,	'need_updateE'	=> 'E'*/
                ,	'restrict_customer_clearance_in'	=> array(0,2)));
            ...
            $stockin_option_item_result	= $this->master_item_stock_model->getOptionItemStockInfo(
                ...
                ,	'stock_status'						=> 'N'
                    /*	,	'currentqty_upper'					=> 2
                        ,	'exclude_account_type_bit_lower'	=> 1*/
                ,   'exclude_account_type_bit_insotck'=>array('1','4', $overseasInventoryCheckNum) /*해외품절,해외판매중,재고*/
                    /*,	'need_updateE'	=> 'E'*/
                    /*,	'need_updateY'	=> 'E'*/
                ,	'restrict_customer_clearance_in'	=> array(0,2)));
         ...
         * 국내사용자용 처리
         */
        $domesticInventoryCheckNum = 0; // 국내 사업자 $overseasInventoryCheckNum 보다 재고가 >= 품절해제, 작으면 품절
