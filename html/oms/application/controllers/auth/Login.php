...
//            if(trim(element('USER_PASSWORD', $user_info)) == $passwd){
                $this->session->set_userdata(
                    array(
                        'oms_manager_id' => trim(element('worker_id', $user_info)),
                        'oms_manager_name' => trim(element('USER_NAME', $user_info)),
                        'oms_worker_id' => trim(element('worker_id', $user_info)),
                        'oms_manager_user_id' => trim(element('USER_ID', $user_info))
                    )
                );
                redirect(site_url('dashboard'));
//            }
    ...
    {
        $this->session->unset_userdata(array('oms_manager_id', 'oms_manager_name', 'oms_worker_id'));
