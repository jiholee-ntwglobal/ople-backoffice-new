...
class Soldout_exclude_item extends CI_Controller
{
    ...
    public function save()
    {
        ...
        $soldout_exclude_item_id = $this->soldout_exclude_item_model->add(
            array(
                ...
                'memo'  =>  $memo,
                'create_worker_id' => $this->session->userdata('oms_manager_id'),
    ...
    private function dowloadExcel($data)
    {
        ...
        $excel_title = '뉴베이_품절예외상품_' . date('Y-m-d');
    ...
    public function updateExcludeItem(){
        ...
        $this->soldout_exclude_item_model->update(array("memo"=>$this->input->post("memo"),"account_type"=>$account_type, "create_worker_id"=>$this->session->userdata('oms_manager_id')), array("soldout_exclude_item_id"=>$this->input->post("soldout_exclude_item_id"), "account_type" => element('account_type', $item_info)));
    ...
    function saveExcelItems(){
        ...
        $upload_dir = '/ssd/html/oms/file/soldout_exclude_item/';
