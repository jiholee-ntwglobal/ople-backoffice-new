...
<script type="text/javascript">
    ...
    function saveMapping() {
        ...
        if(confirm("입력하신 상품정보로 매핑처리 하시겠습니까?")){
            ...
            $.ajax({
                ...
                async: false,
                dataType: "json",
                url: "http://oms.ntwsec.com/oms/order/order/saveMapping",
    ...
    function addMappingProduct(virtual_item_id) {
        ...
        $.ajax({
            ...
            async: false,
            dataType: "json",
            url: "http://oms.ntwsec.com/oms/order/order/getItemInfo",
    ...
    function searchMappingItem() {
        ...
        $.ajax({
            ...
            async: false,
            dataType: "html",
            url: "http://oms.ntwsec.com/oms/order/order/mapping_search",
