...
<form role="form" method="post" action="<?php echo site_url('item/single_item/uploadSingleItem') ?>" enctype="multipart/form-data">
    ...
    <div class="modal-footer">
        ...
        <button class="btn btn-info btn-lg" type="button" onclick="location.href='http://oms.ntwsec.com/oms/file/single_item/newbay_single_item_sample.xlsx';">샘플 파일 다운</button>
    </div>
</form>
