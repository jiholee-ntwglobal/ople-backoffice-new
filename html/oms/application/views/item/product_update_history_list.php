...
<strong style="color: red;">※ 매시 25분에 가격 업데이트 진행(ex 05:25, 06:25) </strong><br>
...
<form method="GET">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <button class="btn btn-info" type="button" onclick="location.href='http://oms.ntwsec.com/oms/file/newbay_item_update_price_sample.xlsx'">샘플 파일 다운</button>
        </div>
