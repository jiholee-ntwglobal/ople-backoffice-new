...
$db['ntshipping']['hostname'] = 'ntics.ntwsec.com';
$db['ntshipping']['username'] = 'sa';
$db['ntshipping']['password'] = 'Tlstkddnr80';
$db['ntshipping']['database'] = 'ntshipping';
$db['ntshipping']['dbdriver'] = 'pdo';
$db['ntshipping']['dsn'] = "dblib:host={$db['ntshipping']['hostname']};port=1433;dbname={$db['ntshipping']['database']}";
$db['ntshipping']['dbprefix'] = '';
$db['ntshipping']['pconnect'] = FALSE;
$db['ntshipping']['db_debug'] = TRUE;
$db['ntshipping']['cache_on'] = FALSE;
$db['ntshipping']['cachedir'] = '';
$db['ntshipping']['char_set'] = 'utf8';
$db['ntshipping']['dbcollat'] = 'utf8_general_ci';
$db['ntshipping']['swap_pre'] = '';
$db['ntshipping']['autoinit'] = TRUE;
$db['ntshipping']['stricton'] = FALSE;
